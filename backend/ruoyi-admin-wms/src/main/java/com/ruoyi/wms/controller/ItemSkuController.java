...
public class ItemSkuController extends BaseController {
    ...
    public TableDataInfo<ItemSkuMapVo> list(ItemSkuBo bo, PageQuery pageQuery, @RequestParam(value = "itemKeywords", required = false) String itemKeywords) {
        return itemSkuService.queryPageList(bo, pageQuery, itemKeywords);
    }
    /**
     * 查询sku信息列表
     */
