...
public class ItemService {
    ...
    private void validateBoBeforeSave(ItemBo itemBo) {
        ...
        validateItemLocation(itemBo.getSku());
    }
    ...
    private void validateItemLocation(List<ItemSkuBo> skuVoList) {
        skuVoList.forEach(sku -> {
            if ("".equals(sku.getItemLocationId())) {
                sku.setItemLocationId(null);
            }
            if (sku.getItemLocationId() == null) {
                sku.setItemLocationId(null);
            }
        });
    }
