<template>
  <div class="app-container">
    <el-card>
      <el-form :model="queryParams" ref="queryRef" :inline="true" label-width="98px" @submit.prevent @keyup.enter="handleQuery">
        <div style="display: flex;">
          <el-form-item label="综合搜索" style="flex: 1;">
            <el-input v-model="queryParams.keyword" clearable placeholder="搜索移库单号 / 备注 / 源仓库 / 目标仓库 / 商品·规格·条码（多个关键字用空格分隔）"/>
          </el-form-item>
          <el-form-item>
